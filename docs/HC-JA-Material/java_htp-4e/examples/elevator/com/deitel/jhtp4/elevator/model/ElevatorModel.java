...
package com.deitel.jhtp4.elevator.model;

// Java core packages
import java.util.*;

// Deitel packages
import com.deitel.jhtp4.elevator.event.*;
import com.deitel.jhtp4.elevator.ElevatorConstants;

public class ElevatorModel implements ElevatorModelListener,
   ElevatorConstants {
   ...
   public void setElevatorModelListener( 
      ElevatorModelListener listener )
   {
